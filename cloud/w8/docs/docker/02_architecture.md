...
Hình dưới đây tóm tắt kiến trúc Docker theo mô hình client-server và luồng từ client đến registry:

![Docker Architecture Overview](../../assets/docker_architecture_overview.svg)
